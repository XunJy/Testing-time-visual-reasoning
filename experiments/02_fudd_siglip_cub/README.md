# Experiment 02: FuDD + SigLIP on CUB-200-2011
...
SigLIP backend under `src/ttvr/models/`.

Before the first test-set run, lock the exact SigLIP checkpoint, preprocessing,
...
directory or presented as SigLIP results.
